...
class Dataset_Regreesion(Dataset):
    ...
    def __read_data__(self):
        ...
        self.data_x = torch.from_numpy(self.data_x).float().to(self.device) # (n_samples, n_features)
        self.data_y = torch.from_numpy(self.data_y).float().to(self.device) # (n_samples, 1)
        self.data_stamp = torch.from_numpy(self.data_stamp).float().to(self.device)
