...
class Model(nn.Module):
    ...
    def MLP_temporal(self, x, B, N, L):
        # [B, N, T, D]
        x = torch.fft.rfft(x.float(), dim=2, norm='ortho')  # FFT on L dimension
    ...
    def MLP_channel(self, x, B, N, L):
        ...
        x = x.permute(0, 2, 1, 3)
        # [B, T, N, D]
        x = torch.fft.rfft(x.float(), dim=2, norm='ortho')  # FFT on N dimension
    ...
    def FreMLP(self, B, nd, dimension, x, r, i, rb, ib):
        ...
        y = torch.view_as_complex(y.float())
        return y
