...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        q_mat_dir = configs.q_mat_dir #configs.Q_MAT_file if self.Q_chan_indep else configs.q_mat_dir
        ...
        q_out_mat_dir = configs.q_out_mat_dir # configs.Q_OUT_MAT_file if self.Q_chan_indep else configs.q_out_mat_file
        ...
        self.revin_layer = Normalize(self.enc_in, affine=True, non_norm=False)
