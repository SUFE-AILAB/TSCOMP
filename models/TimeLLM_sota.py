...
class Model(nn.Module):
    ...
    def __init__(self, configs, using_prompt=False, frozen=True,
        ...
        configs.content = 'The Electricity Transformer Temperature (ETT) is a crucial indicator in the electric power long-term deployment.'
    ...
    def calcute_lags(self, x_enc):
        q_fft = torch.fft.rfft(x_enc.permute(0, 2, 1).contiguous().float(), dim=-1)
        k_fft = torch.fft.rfft(x_enc.permute(0, 2, 1).contiguous().float(), dim=-1)
